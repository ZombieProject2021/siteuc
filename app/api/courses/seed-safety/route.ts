...
const safetyCourses = [
  {
    ...
    description: 'Программа обучения безопасным методам и приемам выполнения работ ��овышенной опасности, к которым предъявляются дополнительные требования в соответствии с нормативными правовыми актами, содержащими государственные нормативные требования охраны труда.',
  ...
  },
  {
    ...
    description: 'Безопасные методы и приемы выполнения работ при воздействии вредных и (или) опасных производст��енных факторов, источников опасности, и��ентифицированных в рамках СОУТ и оценки профрисков. Программа «В»',
    category: 'Охрана труда',
    duration: '16 ак.ч.',
    price: 8000,
    status: 'ACTIVE' as const,
  ...
  },
  {
    ...
    description: 'Обучение безопасным методам выполнения строительных работ, включая окрасочные, эле��тросварочные и газосвароч��ые работы.',
    category: 'Охрана труда',
    duration: '40 ак.ч.',
    price: 20000,
    status: 'ACTIVE' as const,
