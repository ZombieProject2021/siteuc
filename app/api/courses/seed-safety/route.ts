...
const safetyCoursesRaw = [
  ...
  {
    title: 'Програ��ма «В». Безопасные методы и приемы выполнения работ при воздействии вредных факторов',
  ...
  },
  {
    ...
    description: 'Программа «Б» - безопасные методы и приемы выполн��ния работ в соответствии с требованиями охраны труда.',
    category: 'Охрана труда',
    duration: '16 ак.ч.',
    price: 7500,
    status: 'ACTIVE' as const,
  ...
  },
  {
    ...
    level: 'Для всех категорий работников',
    format: 'Очное или дистанционное обуч��ние'
  },
  {
  ...
  },
  {
    ...
    avgRating: 4.7,
    reviewsCount: 32,
    schedule: 'Б��дни: Пн, Ср, Пт с 15:00 до 19:00',
  ...
  },
  {
    ...
    description: 'Обучение безопасным методам выполнения работ н�� высоте. Применение систем обеспечения безопасности работ на высоте.',
    category: 'Охрана труда',
    duration: '32 ак.ч.',
    price: 18000,
    status: 'ACTIVE' as const,
  ...
  },
  {
    ...
    level: 'Для операторо�� подъемных сооружений',
    format: 'Теоретическое и практическое обучение'
  },
  {
  ...
  },
  {
    ...
    description: 'Общие вопросы охраны труда и функционирования системы управления охраной труда (ПП № 2464 от 24.12.2021, п. 46, подпу��кт «а»). Программа «А»',
    category: 'Охрана труда',
    duration: '16 ак.ч.',
    price: 8000,
    status: 'ACTIVE' as const,
  ...
  },
  {
    ...
    format: 'П��актическое обучение с кейсами'
  },
  {
  ...
  {
    title: 'Система управл��ния охраной труда (повышение квалификации)',
...
const safetyCourses = safetyCoursesRaw.map(({ avgRating, reviewsCount, ...course }: any) => course)
