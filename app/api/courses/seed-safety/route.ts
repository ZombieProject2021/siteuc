...
const safetyCoursesRaw = [
  ...
  },
  {
    ...
    description: 'Об��чение безопасным методам выполнения газоопасных работ. Программа включает изучение требований безопасности при работах в газоопасных средах.',
    category: 'Охрана труда',
    duration: '32 ак.ч.',
    price: 20000,
    status: 'ACTIVE' as const,
  ...
  {
    title: 'Организац��я процессов обеспечения работников СИЗ',
