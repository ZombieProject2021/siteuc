...
const safetyCourses = [
  ...
  },
  {
    ...
    description: 'Безопасные методы и приемы выполнения работ при воздействии вредных и (или) опасных производственных факторов, источников опасности, идентифицированных в рамках СО��Т и оценки профрисков. Программа «В»',
    category: 'Охрана труда',
    duration: '16 ак.ч.',
    price: 8000,
    status: 'ACTIVE' as const,
  ...
  },
  {
    ...
    description: 'Подготовка инструкторов по охране труда в соответствии с требованиями ГОСТ 12.0.004-2015. Прог��амма включает методики проведения инструктажей и обучения персонала.',
    category: 'Охрана труда',
    duration: '72 ак.ч.',
    price: 25000,
    status: 'ACTIVE' as const,
  ...
  },
  {
    ...
    format: 'Очное обучение с практ��кой на стенде'
  },
  {
    ...
    level: 'Для работников, работающих на высоте',
  ...
  },
  {
    ...
    description: 'Общие вопросы охраны труда и функционирован��я системы управления охраной труда (ПП № 2464 от 24.12.2021, п. 46, подпункт «а»). Программа «А»',
    category: 'Охрана труда',
    duration: '16 ак.ч.',
    price: 8000,
    status: 'ACTIVE' as const,
  ...
  },
  {
    ...
    description: 'Организация процессов в области обеспечения работников специальной одеждой, специальной обувью и другими средствами индивидуал��ной защиты.',
    category: 'Охрана труда',
    duration: '24 ак.ч.',
    price: 15000,
    status: 'ACTIVE' as const,
    ...
    currentStudents: 8,
    schedule: 'Модульное обучение: 3 дня по 8 часов',
    level: 'Для специалистов по охране труда и к��драм',
  ...
  },
  {
    ...
    format: 'Очно-заочное обучение с дипломо��'
  },
  {
