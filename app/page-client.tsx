...
export default function HomePageClient() {
  ...
  const testimonials = [
    {
      ...
      rating: 5,
      text: 'Прошла курс по управлению персон��лом. Отличная программа, много практических кейсов. После обучения получила повышение и увеличение зарплаты на 40%.'
    },
    {
      name: 'Дмитрий Иванов',
  ...
  return (
    <div suppressHydrationWarning>
        ...
        <div className="relative container mx-auto px-4 py-16 md:py-20">
          <HydrationSafe className="max-w-5xl mx-auto text-center">
            ...
            <DynamicContent
              ...
              defaultContent="Дополнительное профессиональное образование с выдачей документов государствен��ого образца"
              tag="p"
              className="text-lg md:text-xl lg:text-2xl mb-8 text-blue-100 max-w-4xl mx-auto"
              editable={true}
              multiline={true}
              placeholder="Введите описание на главной странице"
            />
      ...
      {/* Rest of the page content remains the same but wrapped in suppressHydrationWarning divs */}
      <div suppressHydrationWarning>
        {/* Popular Programs */}
                  ...
                  <div key={index} className="flex items-start p-6 bg-white rounded-lg shadow-sm">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600 text-sm">
                        ...
                        {benefit.defaultText === 'Рассрочка без переплат' && 'Удобная оплата до 12 меся��ев'}
